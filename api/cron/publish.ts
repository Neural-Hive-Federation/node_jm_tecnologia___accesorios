...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  ...
  try {
    ...
    // Configuración de metadatos del nodo (ADN de Jm Tecnologia   Accesorios)
    const nodeId = 'node_jm_tecnologia___accesorios';
    const businessName = 'Jm Tecnologia   Accesorios';
    const niche = 'General';
    const city = 'Colombia';
